      ...
      <section className="mx-auto max-w-7xl space-y-6">
        <header className="rounded-3xl border border-[#1E293B] bg-[#112240] p-6 shadow-2xl shadow-black/30 md:p-8">
          ...
          <div className="mt-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div><p className="text-xs font-bold uppercase tracking-[0.35em] text-[#3B82F6]">Delivery Intelligence • 10,000 trial model</p><h1 className="mt-3 text-3xl font-black tracking-tight md:text-5xl">Agile Velocity &amp; Capacity Forecaster</h1><p className="mt-4 max-w-3xl text-base leading-7 text-[#94A3B8]">Convert capacity assumptions into a risk-adjusted delivery commitment, then export the executive decision memo in one click.</p></div>
