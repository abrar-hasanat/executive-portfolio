...
const dashboardData: Record<Sector, SectorDashboardData> = {
  "All Sectors": {
    kpis: [
      { label: "Total Pipeline Value", value: "$154K", helper: "60 Active Tenders" },
      { label: "Risk-Adjusted Revenue", value: "$98K", helper: "Monte Carlo Simulated Expected Value" },
    ...
    stages: [
      { name: "Lead Staging", value: "$32K", tenders: 12, progress: 78 },
      { name: "Technical Evaluation", value: "$41K", tenders: 15, progress: 100 },
      { name: "Commercial Proposal", value: "$38K", tenders: 18, progress: 93 },
      { name: "Final Negotiation", value: "$28K", tenders: 8, progress: 68 },
      { name: "Won", value: "$15K", tenders: 7, progress: 37 },
    ],
  ...
  "Commercial Construction": {
    kpis: [
      { label: "Total Pipeline Value", value: "$64K", helper: "24 Active Tenders" },
      { label: "Risk-Adjusted Revenue", value: "$40K", helper: "Monte Carlo Simulated Expected Value" },
    ...
    stages: [
      { name: "Lead Staging", value: "$14K", tenders: 5, progress: 82 },
      { name: "Technical Evaluation", value: "$17K", tenders: 6, progress: 100 },
      { name: "Commercial Proposal", value: "$15K", tenders: 7, progress: 88 },
      { name: "Final Negotiation", value: "$11K", tenders: 3, progress: 65 },
      { name: "Won", value: "$7K", tenders: 3, progress: 41 },
    ],
  ...
  "Government Procurement": {
    kpis: [
      { label: "Total Pipeline Value", value: "$57K", helper: "22 Active Tenders" },
      { label: "Risk-Adjusted Revenue", value: "$38K", helper: "Monte Carlo Simulated Expected Value" },
    ...
    stages: [
      { name: "Lead Staging", value: "$10K", tenders: 4, progress: 63 },
      { name: "Technical Evaluation", value: "$15K", tenders: 6, progress: 94 },
      { name: "Commercial Proposal", value: "$16K", tenders: 7, progress: 100 },
      { name: "Final Negotiation", value: "$10K", tenders: 3, progress: 63 },
      { name: "Won", value: "$6K", tenders: 2, progress: 38 },
    ],
  ...
  Infrastructure: {
    kpis: [
      { label: "Total Pipeline Value", value: "$33K", helper: "14 Active Tenders" },
      { label: "Risk-Adjusted Revenue", value: "$20K", helper: "Monte Carlo Simulated Expected Value" },
    ...
    stages: [
      { name: "Lead Staging", value: "$8K", tenders: 3, progress: 73 },
      { name: "Technical Evaluation", value: "$9K", tenders: 3, progress: 82 },
      { name: "Commercial Proposal", value: "$7K", tenders: 4, progress: 64 },
      { name: "Final Negotiation", value: "$7K", tenders: 2, progress: 64 },
      { name: "Won", value: "$2K", tenders: 2, progress: 18 },
    ],
